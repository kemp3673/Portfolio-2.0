    ...
    <div className="about" id="about">
      ...
      <div className="aboutContainer">
        <p className="aboutDescription">
          ...
          am a lifelong learner with a passion for technology, and I am eager to
          apply my skills and experience to new challenges in the industry. In
          my free time, I enjoy hobbies such as Dungeons and Dragons, 3D
